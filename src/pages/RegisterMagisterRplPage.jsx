...
// Komponen-komponen pembantu dipindahkan ke luar untuk performa yang lebih baik
...
/**
 * Komponen untuk halaman registrasi Program Magister (S2) Jalur RPL.
 */
const RegisterMagisterRplPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // [MODIFIKASI] Mengirim ke endpoint yang benar
            const response = await fetch('http://127.0.0.1:8000/api/register-magister-rpl', {
                method: 'POST',
                headers: {
            ...
            // [MODIFIKASI] Pesan sukses yang disesuaikan
            setSuccessMessage('Registrasi Magister RPL berhasil! Anda akan diarahkan ke halaman login.');
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8">
                <div className="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg overflow-y-auto" style={{ maxHeight: '95vh' }}>
                     <div className="text-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">Daftar Akun Magister (RPL)</h1>
                    </div>
...
export default RegisterMagisterRplPage;
