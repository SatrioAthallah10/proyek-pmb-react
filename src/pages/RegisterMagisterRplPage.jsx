...
/**
 * Komponen untuk halaman registrasi khusus jalur Magister RPL.
 */
const RegisterMagisterRplPage = ({ setCurrentPage }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage('Registrasi Magister RPL berhasil! Silakan login.');
            setFormData({
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8">
                <div className="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg overflow-y-auto" style={{ maxHeight: '95vh' }}>
                     <div className="text-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">Daftar Akun Baru (Magister RPL)</h1>
                    </div>
