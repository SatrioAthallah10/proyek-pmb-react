    ...
    const renderView = () => {
        ...
        switch (activeView) {
            case 'konfirmasi-pembayaran':
                return <KonfirmasiPembayaranView {...commonProps} />;
            case 'pendaftaran-awal':
                return <PendaftaranAwalView {...commonProps} />;
            case 'konfirmasi-daftar-ulang':
                 if (isTesLulus) { return <KonfirmasiDaftarUlangView {...commonProps} />; }
            ...
            case 'tes-seleksi':
                return <TesSeleksiView {...commonProps} />;
            case 'soal-tes':
                return <SoalTesView {...commonProps} />;
            case 'hasil-tes':
                return <HasilTesView {...commonProps} />;
            case 'ktm':
                return <KtmView />;
            case 'daftar-ulang':
                if (isPembayaranDafulCompleted) { return <DaftarUlangView {...commonProps} />; }
