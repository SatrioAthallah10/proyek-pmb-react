...
/**
 * Komponen untuk halaman registrasi yang komprehensif.
 */
const RegisterPage = ({ setCurrentPage }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                if (data.email) { // Cek error spesifik dari validasi Laravel
            ...
            setFormData({
                ...
                jalur: 'Reguler', sumberPendaftaran: '', password: '', konfirmPassword: '', agreePolicy: false,
            });
